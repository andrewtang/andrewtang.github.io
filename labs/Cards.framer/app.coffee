# Import file "cards_app_sketch2"
$ = Framer.Importer.load("imported/cards_app_sketch2@1x")
...
# Add states
$.card_1.states.add
	two: x: -590, y: 190, scale: 0.85, originX: 1, originY: 0, z: 1
	three: x: -1200, y: 190, scale: 0.85, originX: 1, originY: 0
$.card_1.states.animationOptions = curve: 'spring(200, 20, 0)'

$.card_2.states.add
	two: scale: 1, x: 66, y: 160, originX: 0, originY: 0, z: 2
	three: scale: 0.85, x: -590, y: 190, originX: 1, originY: 0, z: 1
