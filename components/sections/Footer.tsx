    ...
    <footer className="py-12 px-6 md:px-16" role="contentinfo">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start lg:items-center">
        ...
        <p className="text-sm text-muted dark:text-muted-dark inline-flex items-center gap-1 group">
          Made with <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-block transition-all group-hover:stroke-red-500 group-hover:fill-red-500 group-hover:scale-110" aria-hidden="true"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg> in Melbourne, Australia
        </p>
      </div>
    </footer>
  );
